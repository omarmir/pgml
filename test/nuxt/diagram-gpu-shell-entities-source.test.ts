...
describe('diagram GPU shell entities source', () => {
  it('restores the rich entities browser in the GPU shell', () => {
    ...
    expect(shellFile).toContain('const snapToGrid: Ref<boolean> = ref(true)')
    ...
    expect(shellFile).toContain('const showCustomTypes: Ref<boolean> = ref(true)')
    expect(shellFile).toContain('const diagramVisibilitySettingItems: DiagramVisibilitySettingItem[] = [')
    expect(shellFile).toContain('const toggleSnapToGrid = () => {')
    expect(shellFile).toContain('const applyDiagramVisibilityDraft = () => {')
    expect(shellFile).toContain('syncLayoutStates()')
    expect(shellFile).toContain('data-diagram-view-select="desktop"')
    expect(shellFile).toContain('data-diagram-view-settings="desktop"')
    expect(shellFile).toContain('data-diagram-view-create="desktop"')
    expect(shellFile).toContain('data-diagram-view-rename="desktop"')
    expect(shellFile).toContain('data-diagram-view-delete="desktop"')
    expect(shellFile).toContain('data-diagram-view-settings="mobile"')
    expect(shellFile).toContain('data-diagram-view-rename="mobile"')
    expect(shellFile).toContain('data-diagram-view-settings-dialog="true"')
    expect(shellFile).toContain('View')
    expect(shellFile).toContain('Save settings')
