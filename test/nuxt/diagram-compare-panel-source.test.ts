...
describe('diagram compare panel source', () => {
  it('renders a dedicated compare inspector and syncs it with the diagram shell', () => {
    ...
    expect(versionsPanelFile).toContain('\'open-migrations\': []')
    expect(versionsPanelFile).toContain('data-version-open-comparator="true"')
    expect(versionsPanelFile).toContain('data-version-open-migrations="true"')
    expect(versionsPanelFile).toContain('data-version-workspace-compare-base="true"')
    expect(versionsPanelFile).toContain('data-version-workspace-compare-target="true"')
    expect(versionsPanelFile).toContain(':data-version-compare-base="version.id"')
    expect(versionsPanelFile).toContain(':data-version-compare-target="version.id"')
