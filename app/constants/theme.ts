...
const darkStudioThemeTokens = Object.freeze({
  ...
  '--studio-editor-punctuation': 'rgba(226, 232, 240, 0.72)',
...
type StudioThemeTokenName = keyof typeof darkStudioThemeTokens
type StudioThemeTokenMap = Readonly<Record<StudioThemeTokenName, string>>

const lightStudioThemeTokens: StudioThemeTokenMap = Object.freeze({
  ...
  '--studio-editor-punctuation': '#475569',
  ...
  '--studio-surface-hover': 'rgba(15, 23, 42, 0.1)',
  ...
  '--studio-input-bg': 'rgba(255, 255, 255, 0.92)',
...
export const studioThemeTokens: Readonly<Record<StudioTheme, StudioThemeTokenMap>> = Object.freeze({
  dark: darkStudioThemeTokens,
  light: lightStudioThemeTokens
})
