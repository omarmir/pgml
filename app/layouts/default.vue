...
<template>
  ...
  >
    <header class="fixed inset-x-0 top-0 z-50 border-b border-[color:var(--studio-shell-border)] bg-[color:var(--studio-shell-bg)]/94 backdrop-blur">
      <div class="relative mx-auto flex min-h-[3.6rem] w-full max-w-[1480px] items-center justify-between gap-3 px-4 py-2 sm:px-6 lg:px-8">
        ...
        <div class="flex shrink-0 items-center gap-1.5">
          <AppMobileNavigationMenu :navigation-items="navigationItems" />
          <AppThemeToggleButton />
        </div>
      </div>
    </header>

    <div class="relative mx-auto flex min-h-screen w-full min-w-0 max-w-[1480px] flex-col px-4 pt-[3.6rem] sm:px-6 lg:px-8">
