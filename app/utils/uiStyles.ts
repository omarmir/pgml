...
export const studioModalSurfaceClass = 'flex w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-none border'
export const studioModalHeaderClass = 'flex items-start justify-between gap-4 border-b border-[color:var(--studio-shell-border)] px-4 py-3'
export const studioModalFooterClass = 'flex items-center justify-end gap-2 border-t border-[color:var(--studio-shell-border)] px-4 py-3'
